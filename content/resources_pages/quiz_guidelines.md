...
Quiz results may only be reviewed by booking and attending a quiz review session at the ORCA. These sessions are typically held one week after the quiz. Reservations follow the same process as for quizzes, but students only need to book a single time slot to review all quizzes from the previous week.

### Quiz procedure overview
